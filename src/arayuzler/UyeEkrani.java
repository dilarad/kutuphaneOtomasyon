...
public class UyeEkrani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/arayuzler/profile.png"))); // NOI18N
        ...
        soyad_alani.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N

        tel_alani.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N

        mail_alani.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N

        adres_alani.setColumns(20);
        adres_alani.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        adres_alani.setLineWrap(true);
        adres_alani.setRows(5);
        adres_alani.setToolTipText("");
        jScrollPane2.setViewportView(adres_alani);

        dogum_tarihi_alani.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        ...
        uye_ekle.setBackground(new java.awt.Color(82, 99, 139));
        uye_ekle.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        uye_ekle.setForeground(new java.awt.Color(255, 255, 255));
        ...
        uye_guncelle.setBackground(new java.awt.Color(82, 99, 139));
        uye_guncelle.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        uye_guncelle.setForeground(new java.awt.Color(255, 255, 255));
        ...
        uye_sil.setBackground(new java.awt.Color(82, 99, 139));
        uye_sil.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
